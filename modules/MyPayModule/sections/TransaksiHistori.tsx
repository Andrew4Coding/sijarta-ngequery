...
export const TransaksiHistori = ({
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-4 gap-y-4 md:gap-y-8 pb-2 h-fit overflow-y-scroll overflow-x-visible w-full">
        ...
        return (
          <React.Fragment key={item.id}>
            ...
            (index > 0 &&
              ...
              <div className="xl:col-span-2 h-fit bg-green-500 rounded-[12px] p-5 text-white text-sm font-bold mt-4">
                {date}
              </div>
            ) : null}
            <div
              className={cn(
                "rounded-lg bg-transparent h-fit border border-[#FFCDCD] px-2 xl:px-10 py-6 shadow-sm flex justify-between items-center hover:scale-105 duration-300",
