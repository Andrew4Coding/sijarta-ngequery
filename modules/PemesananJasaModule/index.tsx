...
>>>>>>> 5ff8f2e846317d76c38c4636483b3dd3eabcfb08
...
=======
    ...
    useEffect(() => {
        const fetchStatusData = async () => {
            const response = await fetch("/api/statusPemesananJasa");
            const data = await response.json();
            if (data.success) {
                console.log(data)
                setStatusData(data.data); // Assuming the data contains status info
            }
        };
        fetchStatusData();
    }, []);
        ...
        <div className="flex gap-4 mb-4 max-w-md">
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>
                <SelectLabel>Subkategori</SelectLabel>
                <SelectItem value="Konsultasi Bisnis">
                  Konsultasi Bisnis
                </SelectItem>
                <SelectItem value="Konsultasi Keuangan">
                  Konsultasi Keuangan
                </SelectItem>
              </SelectGroup>
            </SelectContent>
                  ...
                  order.status === "Mencari Pekerja Terdekat" ? (
                    ...
                    <Dialog>
                      ...
                      <DialogContent>
                        <DialogTitle>Buat Testimoni</DialogTitle>
                        <DialogDescription>
                          Berikan rating dan komentar Anda tentang layanan ini
                        </DialogDescription>
